      ...
      <nav className="border-b border-slate-200 bg-white">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5 lg:px-0">
          ...
          <div className="hidden items-center gap-8 md:flex">
            <Link to="/" className="font-medium text-[#0D47D9]">
              Home
            </Link>
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-6 max-w-xl text-lg leading-8 text-slate-600">
              Learn practical technology skills, develop your creativity, and
              gain the knowledge you need to move forward in the digital world.
            </p>
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-5 leading-7 text-slate-600">
              Saystech Computer Hub is focused on helping individuals develop
              practical computer and technology skills through learning and
              hands-on experience.
            </p>

            <p className="mt-4 leading-7 text-slate-600">
              Whether you are beginning your technology journey or looking to
              improve your existing skills, Saystech provides an environment
              where you can learn, create, and grow.
            </p>
          ...
          <div className="rounded-2xl bg-slate-50 p-8">
            <div className="grid grid-cols-2 gap-5">
              <div className="rounded-xl bg-white p-6 shadow-sm">
                <FaLaptopCode size={25} className="text-[#0D47D9]" />
              ...
              <div className="rounded-xl bg-white p-6 shadow-sm">
                <FaGraduationCap size={25} className="text-[#0D47D9]" />

                <h3 className="mt-4 font-semibold text-slate-900">Learning</h3>
              ...
              <div className="rounded-xl bg-white p-6 shadow-sm">
                <FaPalette size={25} className="text-[#0D47D9]" />
              ...
              <div className="rounded-xl bg-white p-6 shadow-sm">
                <FaNetworkWired size={25} className="text-[#0D47D9]" />
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-slate-600">
              Explore the technology and digital services available at Saystech
              Computer Hub.
            </p>
          </div>
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="rounded-2xl bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-md">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-600">
                Learn useful digital skills through structured courses and
                practical lessons.
              </p>
            </div>
            ...
            <div className="rounded-2xl bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-md">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-600">
                Develop creative skills and create professional digital designs.
              </p>
            </div>
            ...
            <div className="rounded-2xl bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-md">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-600">
                Learn networking concepts and practical computer infrastructure.
              </p>
            </div>
          </div>
      ...
      <section className="px-6 py-20 lg:px-8">
        <div className="mx-auto max-w-6xl rounded-3xl bg-[#0D47D9] px-8 py-14 text-center text-white">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-blue-100">
            Take the next step and start building the technology skills you need
            for your future.
          </p>
          ...
          <div className="grid gap-10 md:grid-cols-3">
            ...
            <div>
              ...
              <p className="mt-4 max-w-sm text-sm leading-6 text-slate-500">
                Building practical technology skills and creating opportunities
                for learning and growth in the digital world.
              </p>
            </div>
